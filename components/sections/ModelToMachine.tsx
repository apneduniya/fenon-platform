...
export function ModelToMachine() {
  ...
  return (
    <section id={heading.id} aria-labelledby={`${heading.id}-title`} className="scroll-mt-8 pt-[80px] lg:pt-[137px]">
      <Container>
        <SectionHeading heading={heading} className="border-b border-border pb-[29px] lg:pb-[39px]" />

        <div className="grid gap-12 border-b border-border pt-[27px] pb-6 lg:grid-cols-[1fr_610px] lg:gap-10 lg:pt-[39px] lg:pb-[40px]">
