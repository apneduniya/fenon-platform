...
export function InferenceLifecycle() {
  ...
  return (
    <section id={heading.id} aria-labelledby={`${heading.id}-title`} className="scroll-mt-8 pt-[78.5px] lg:pt-[119px]">
      <Container>
        <SectionHeading heading={heading} />
        <div className="mt-[29px] rounded-xl border border-border bg-muted px-5 pt-6 pb-[23px] lg:mt-10 lg:px-9 lg:pt-8 lg:pb-6">
